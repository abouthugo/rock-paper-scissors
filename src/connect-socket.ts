...
import type { CardChoice, UserType } from "./game-state-provider";
...
export default function connectSocket() {
    ...
    //WARNING: !Make sure this happens on 'beforeunload' event
    ...
    const subToOpponentMove = (
        handler: (opponentChoice: CardChoice) => void,
    ) => {
